...
# Get the samples
current_mapping <- get_samples_by(mapping = mapping, template = "RNA")
...
rownames(labels_coordinates) <- as.character(rownames(biplot_all))


# Manually setting the coordinates
labels_coordinates[labels_coordinates$name == "Fe", "x"] <- -0.2 + labels_coordinates[labels_coordinates$name == "Fe", "x"]
labels_coordinates[labels_coordinates$name == "Fe", "y"] <- labels_coordinates[labels_coordinates$name == "Fe", "y"]

labels_coordinates[labels_coordinates$name == "Turbidity", "x"] <- -0.4 + labels_coordinates[labels_coordinates$name == "Turbidity", "x"]
labels_coordinates[labels_coordinates$name == "Turbidity", "y"] <- labels_coordinates[labels_coordinates$name == "Turbidity", "y"]

labels_coordinates[labels_coordinates$name == "Absorbance", "x"] <- 0.2 + labels_coordinates[labels_coordinates$name == "Absorbance", "x"]
labels_coordinates[labels_coordinates$name == "Absorbance", "y"] <- 0.2 + labels_coordinates[labels_coordinates$name == "Absorbance", "y"]
...
labels_coordinates[labels_coordinates$name == "MAP", "x"] <- -0.2 + labels_coordinates[labels_coordinates$name == "MAP", "x"]
labels_coordinates[labels_coordinates$name == "MAP", "y"] <- -0.2 + labels_coordinates[labels_coordinates$name == "MAP", "y"]

labels_coordinates[labels_coordinates$name == "HPC", "x"] <- -0.3 + labels_coordinates[labels_coordinates$name == "HPC", "x"]
labels_coordinates[labels_coordinates$name == "HPC", "y"] <- -0.0 + labels_coordinates[labels_coordinates$name == "HPC", "y"]

labels_coordinates[labels_coordinates$name == "DAPI", "x"] <- -0.3 + labels_coordinates[labels_coordinates$name == "DAPI", "x"]
labels_coordinates[labels_coordinates$name == "DAPI", "y"] <- labels_coordinates[labels_coordinates$name == "DAPI", "y"]

labels_coordinates[labels_coordinates$name == "Temperature", "x"] <- 0.25 + labels_coordinates[labels_coordinates$name == "Temperature", "x"]
labels_coordinates[labels_coordinates$name == "Temperature", "y"] <- 0.75 + labels_coordinates[labels_coordinates$name == "Temperature", "y"]
...
if (TRUE) {
  ...
  # Overlapping names
  overlapping_labels <- c("Platyhelminthes", "Basidiomycota", "Ascomycota", "Peronosporomycetes")
  ...
  need_background <- c("Discosea", "Tubulinea", "Embryophyta")
  # Need backgrounds?
  if (TRUE) {
  ...
  if (way == "move") {
    ...
    overlapped[overlapped$text == overlapping_labels[2], "x"] <- 0.0 + species_annotation[species_annotation$text == overlapping_labels[2], "x"]
    overlapped[overlapped$text == overlapping_labels[2], "y"] <- -0.05 + species_annotation[species_annotation$text == overlapping_labels[2], "y"]
    
    overlapped[overlapped$text == overlapping_labels[3], "x"] <- 0.0 + species_annotation[species_annotation$text == overlapping_labels[3], "x"]
    overlapped[overlapped$text == overlapping_labels[3], "y"] <- -0.05 + species_annotation[species_annotation$text == overlapping_labels[3], "y"]
    
    overlapped[overlapped$text == overlapping_labels[3], "x"] <- 0.0 + species_annotation[species_annotation$text == overlapping_labels[3], "x"]
    overlapped[overlapped$text == overlapping_labels[3], "y"] <- -0.0 + species_annotation[species_annotation$text == overlapping_labels[3], "y"]
    
    
  } else if (way == "line") {
    
    overlapped[overlapped$text == overlapping_labels[1], "x"] <- -0.1 + species_annotation[species_annotation$text == overlapping_labels[1], "x"]
    overlapped[overlapped$text == overlapping_labels[1], "y"] <- -0.2 + species_annotation[species_annotation$text == overlapping_labels[1], "y"]
    
    overlapped[overlapped$text == overlapping_labels[2], "x"] <- -0.3 + species_annotation[species_annotation$text == overlapping_labels[2], "x"]
    overlapped[overlapped$text == overlapping_labels[2], "y"] <- -0.2 + species_annotation[species_annotation$text == overlapping_labels[2], "y"]
    
    overlapped[overlapped$text == overlapping_labels[3], "x"] <- -0.4 + species_annotation[species_annotation$text == overlapping_labels[3], "x"]
    overlapped[overlapped$text == overlapping_labels[3], "y"] <- -0.2 + species_annotation[species_annotation$text == overlapping_labels[3], "y"]
    
    overlapped[overlapped$text == overlapping_labels[3], "x"] <- 0.5 + species_annotation[species_annotation$text == overlapping_labels[3], "x"]
    overlapped[overlapped$text == overlapping_labels[3], "y"] <- -1.0 + species_annotation[species_annotation$text == overlapping_labels[3], "y"]
    
  } else if (way == "point") {
    
    overlapped[overlapped$text == overlapping_labels[1], "x"] <- -0.2 + species_annotation[species_annotation$text == overlapping_labels[1], "x"]
    overlapped[overlapped$text == overlapping_labels[1], "y"] <- -0.3 + species_annotation[species_annotation$text == overlapping_labels[1], "y"]
    
    overlapped[overlapped$text == overlapping_labels[2], "x"] <- -0.7 + species_annotation[species_annotation$text == overlapping_labels[2], "x"]
    overlapped[overlapped$text == overlapping_labels[2], "y"] <- -0.4 + species_annotation[species_annotation$text == overlapping_labels[2], "y"]
    
    overlapped[overlapped$text == overlapping_labels[3], "x"] <- -1.2 + species_annotation[species_annotation$text == overlapping_labels[3], "x"]
    overlapped[overlapped$text == overlapping_labels[3], "y"] <- -0.4 + species_annotation[species_annotation$text == overlapping_labels[3], "y"]
    
    overlapped[overlapped$text == overlapping_labels[4], "x"] <- 0.5 + species_annotation[species_annotation$text == overlapping_labels[4], "x"]
    overlapped[overlapped$text == overlapping_labels[4], "y"] <- -1.0 + species_annotation[species_annotation$text == overlapping_labels[4], "y"]
  }
